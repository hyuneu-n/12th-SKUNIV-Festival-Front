...
export const boothData = [
  ...
  },
  {
    ...
    menuDay: { 풍선다트: '', 무알콜칵테일: '', 에이드: '', '동전 던지기': '' },
    menuNight: {
      숙주볶음: '12.0',
      야끼우동: '13.0',
      부대찌개: '15.0',
  ...
  },
  {
    ...
    menuDay: { 전통떡꼬치: '2.5', '피카츄 돈가스': '3.0', 키라키라: '' },
    menuNight: {
      닭갈비: '13.0',
      오뎅탕: '8.0',
      '날치알 주먹밥': '4.0',
  ...
  },
  {
    ...
    intro:
      '마침 배고파질 참이었는데\n나화생 덕분에 너무 재밌짜나 ?✨️💓\n완전 럭키비키쟈낭🍀🍀',
    menuDay: { '뉴욕핫도그(오리지널)': '3.9', 버블티: '3.3' },
    menuNight: {
      두부김치: '9.9',
      묵사발: '7.9',
      김치전: '8.9',
